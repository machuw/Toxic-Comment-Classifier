...
| Model                                        | AUROC  |
| :------------------------------------------- | :----- |
| LSTM without embedding & preprocessing       | 0.9575 |
| LSTM without embedding & with preprocessing  | 0.9610 |
| LSTM with gloVe embedding & preprocessing    | 0.9581 |
| LSTM with fastText embedding & preprocessing | 0.9770 |
